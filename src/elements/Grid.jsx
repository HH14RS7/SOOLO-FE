...
const GridBox = styled.div`
  ${props =>
    props.display_grid ? `display: grid; grid-template-columns: 2fr 1fr; column-gap: 1.6rem;` : ''};
  ...
  ${props => (props.shadow ? `box-shadow: 0px -2px 6px rgba(0, 0, 0, 0.06);` : '')};
  ${props =>
    props.is_flex ? `display: flex; align-items: center; justify-content: space-between;` : ''};
  ${props =>
    props.is_flex2 ? `display: flex; align-items: center; justify-content: center;` : ''};
  ${props => (props.is_flex3 ? `display: flex; justify-content: center;` : '')};
  ${props => (props.is_flex4 ? `display: flex; align-items: center;` : '')};
  ${props =>
    props.is_flex_column ? `display: flex; flex-direction: column; align-items: center;` : ''};
  ...
  ${props => (props.fix_left ? `left: 50%; transform: translateX(-200%);` : '')};
  ...
  @media (min-width: 510px) {
    ${props =>
      props.post_flex ? `display: flex; align-items: center; justify-content: center;` : ''};
  }
`;
